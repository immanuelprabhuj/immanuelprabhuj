    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <form action="http://127.0.0.1:8000/shop-ally/upi/payment" method="post" style="width: 100%">
                {{-- <form action="http://127.0.0.1:8000/stylemirror/upi/payment" method="post" style="width: 100%"> --}}
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <input type="text" class="form-control" name="phone" id="phone" value="{{ $req->phone }}" placeholder="Phone">
                    </div>
                    <div class="form-group col-xs-6">
                        <label for="amount">Amount</label>
                        <input type="text" class="form-control" name="amount" id="amount" value="{{ $req->amount }}" placeholder="Amount">
                    </div>
                    <div class="form-group col-xs-6">
                        <label for="orderId">Order Id</label>
                        <input type="text" class="form-control" name="orderId" id="orderId" value="{{ $req->orderId }}" placeholder="Order Id">
                    </div>
                    <div class="form-group col-xs-6">
                        <label for="callback_url">Callback url</label>
                        <input type="text" class="form-control" name="callback_url" id="callback_url" value="{{ $req->callback_url }}" placeholder="Callback url">
                    </div>
                    <div class="form-group col-xs-6">
                        <label for="redirect_url">Redirect url</label>
                        <input type="text" class="form-control" name="redirect_url" id="redirect_url" value="{{ $req->redirect_url }}" placeholder="Redirect url">
                    </div>
                    <div class="form-group col-xs-6">
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <input type="text" class="form-control" name="merchID" id="merchID" value="{{ $req->merchID }}" placeholder="Merchant ID">
                    </div>
                ...
                <div class="row">
                    <form style="width: 100%">
                        <div class="form-group col-xs-6">
                          ...
                          <input type="time" class="form-control" id="loginTime" value="{{ date('H:i:s') }}" aria-describedby="loginTimeHelp" placeholder="Login Time">
                          {{-- <small id="loginTimeHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                        </div>
                        <div class="form-group col-xs-6">
                          <label for="idletime">Idle Time</label>
                          <input type="time" class="form-control" id="idletime" value="00:00" step="2" placeholder="Idle time">
                        </div>
                        <div class="form-group col-xs-6">
                            <label for="workingtime">Working Time</label>
                            <input type="time" class="form-control" id="workingtime" value="00:00" step="2" placeholder="Working time">
                        </div>
                        <div class="form-group col-xs-6">
                            <label for="breaktime">Break Time</label>
                            <input type="time" class="form-control" id="breaktime" value="00:00" step="2" placeholder="Break time">
                        </div>
                        <div class="form-group col-xs-6">
                            <label for="currenttime">Current Time</label>
                            <input type="time" class="form-control" id="currenttime" disabled step="2" value="{{ date('H:i:s') }}" placeholder="Current time">
                        </div>
                        <div class="form-group col-xs-6">
                            <label for="mworkinghours">Mandatory Working Hours</label>
                            <input type="time" class="form-control" id="mworkinghours" value="07:00" step="2" disabled placeholder="Mandatory Working Hours">
                        </div>
                    </form>
        ...
        <script>
            ...
            $("body").on("change", "#loginTime", function(){
                ...
                balWorkingTime  =   subtractTimes("07:00", time);console.log(balWorkingTime)
            ...
            function subtractTimes(currenttime, loginTime){
                ...
                return padStart(difference.hours()) + ":" + padStart(difference.minutes()) + ":" + padStart(difference.seconds());
            }
